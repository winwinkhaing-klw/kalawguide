...
<head>
    ...
    <title>Famous Places of Kalaw</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                <h2 class="text-center">Welcome <?php echo $name; ?> - <a href="logout.php">Logout</a></h2>
                    <hr>
                    <h2 class="intro-text text-center">Famous
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title">Palung Hill Village</h4>
		  </div>
		  <div class="modal-body">
			<p>First Famous Place</p>
		  </div>
	...
	<div id="myModal2" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="modal-title">Kalaw Entrance</h4>
		  </div>
		  <div class="modal-body">
			<p>Famous Second Place</p>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		  </div>
	...
	<div id="myModal3" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  <div class="modal-header">
			<button type="button" class="close" data-dismiss="modal">&times;</button>
			<h4 class="modal-title">Green Tea Field</h4>
		  </div>
		  <div class="modal-body">
			<p>Famous Third Place</p>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		  </div>
