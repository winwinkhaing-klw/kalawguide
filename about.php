    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Let's Enjoy Your Trip 
                        <strong>With Kalaw Guide</strong>
                    </h2>
                    <hr>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <p>This is one of great website developed by Winnie.</p>
                    <p>Connect with us to get new experience and feel fresh nature.</p>
                </div>
